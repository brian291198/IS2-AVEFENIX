...
@section('content')
    <div class="card">
        <div class="card-header">
          <h3 class="card-title">REGISTRO DE AREAS</h3>
...
<form action="{{route('area.store')}}" method="post">
  ...
  <div class="input-group mb-3">
    <input type="text" class="form-control" placeholder="Nombre de la nueva Area" aria-describedby="basic-addon2" name="Area">
